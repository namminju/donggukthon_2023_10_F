  ...
  return (
      ...
      <div className="popup-overlay">
        ...
        <div className="Quitpopup">
          ...
          <div className='popup_button_container_2'>
          
          <button onClick={onConfirm_q} className='cancel_button' style={{width:'100%', height:'100%'}}>취소</button>
          <button onClick={onQuit} className='confirm_button'style={{width:'100%', height:'100%'}}>확인</button>
        </div>
      </div>
    </div>
  );
